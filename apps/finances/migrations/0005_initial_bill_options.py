...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        orm.Option.objects.create(
            name='Auto Pay',
            description='Bill is paid automatically (withdrawal from account)',
            template_type='bill'
        )

        orm.Option.objects.create(
            name='Auto Transfer',
            description='Money is automatically transferred into desired account to pay bill',
            template_type='bill'
        )

    def backwards(self, orm):
        "Write your backwards methods here."
        orm.Option.objects.all().delete()
    ...
    models = {
        ...
        u'finances.billtemplate': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '100', 'db_index': 'True'}),
            'options': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['finances.Option']", 'symmetrical': 'False'}),
