...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Bill.payment_method'
        db.add_column(u'finances_bill', 'payment_method',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True),
                      keep_default=False)

        # Adding field 'Bill.check_number'
        db.add_column(u'finances_bill', 'check_number',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Bill.payment_method'
        db.delete_column(u'finances_bill', 'payment_method')

        # Deleting field 'Bill.check_number'
        db.delete_column(u'finances_bill', 'check_number')
