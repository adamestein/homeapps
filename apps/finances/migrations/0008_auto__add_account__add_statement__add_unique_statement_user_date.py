...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'finances_account', (
        ...
        db.send_create_signal(u'finances', ['Account'])

        # Adding model 'Statement'
        db.create_table(u'finances_statement', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('date', self.gf('django.db.models.fields.DateField')(db_index=True)),
        ))
        db.send_create_signal(u'finances', ['Statement'])

        # Adding unique constraint on 'Statement', fields ['user', 'date']
        db.create_unique(u'finances_statement', ['user_id', 'date'])


    def backwards(self, orm):
        # Removing unique constraint on 'Statement', fields ['user', 'date']
        db.delete_unique(u'finances_statement', ['user_id', 'date'])

        # Deleting model 'Account'
        db.delete_table(u'finances_account')

        # Deleting model 'Statement'
        db.delete_table(u'finances_statement')
    ...
    models = {
        ...
        u'finances.account': {
            'Meta': {'ordering': "('account_number', 'statement__date')", 'object_name': 'Account'},
