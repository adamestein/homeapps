...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'BillTemplate'
        db.create_table(u'finances_billtemplate', (
            ...
            ('due_day', self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True, blank=True)),
            ...
            ('options', self.gf('django.db.models.fields.PositiveIntegerField')(default=0, blank=True)),
            ('url', self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True)),
        ))
        db.send_create_signal(u'finances', ['BillTemplate'])

        # Adding unique constraint on 'BillTemplate', fields ['name', 'user']
        db.create_unique(u'finances_billtemplate', ['name', 'user_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'BillTemplate', fields ['name', 'user']
        db.delete_unique(u'finances_billtemplate', ['name', 'user_id'])

        # Deleting model 'BillTemplate'
        db.delete_table(u'finances_billtemplate')
    ...
    models = {
        ...
        u'finances.billtemplate': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '100', 'db_index': 'True'}),
            'options': ('django.db.models.fields.PositiveIntegerField', [], {'default': '0', 'blank': 'True'}),
