...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Income'
        db.create_table(u'finances_income', (
        ...
        db.send_create_signal(u'finances', ['Income'])

        # Adding M2M table for field options on 'Income'
        m2m_table_name = db.shorten_name(u'finances_income_options')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('income', models.ForeignKey(orm[u'finances.income'], null=False)),
            ('option', models.ForeignKey(orm[u'finances.option'], null=False))
        ))
        db.create_unique(m2m_table_name, ['income_id', 'option_id'])


    def backwards(self, orm):
        # Deleting model 'Income'
        db.delete_table(u'finances_income')

        # Removing M2M table for field options on 'Income'
        db.delete_table(db.shorten_name(u'finances_income_options'))
