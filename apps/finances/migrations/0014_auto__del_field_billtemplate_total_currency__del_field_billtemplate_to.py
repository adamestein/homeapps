...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'BillTemplate.total_currency'
        db.delete_column(u'finances_billtemplate', 'total_currency')

        # Deleting field 'BillTemplate.total'
        db.delete_column(u'finances_billtemplate', 'total')


    def backwards(self, orm):
        # Adding field 'BillTemplate.total_currency'
        db.add_column(u'finances_billtemplate', 'total_currency',
                      self.gf('djmoney.models.fields.CurrencyField')(default='USD'),
                      keep_default=False)

        # Adding field 'BillTemplate.total'
        db.add_column(u'finances_billtemplate', 'total',
                      self.gf('djmoney.models.fields.MoneyField')(blank=True, null=True, max_digits=10, decimal_places=2, default_currency='USD'),
                      keep_default=False)
