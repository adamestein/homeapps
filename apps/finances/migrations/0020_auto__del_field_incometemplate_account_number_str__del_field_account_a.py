...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'IncomeTemplate.account_number_str'
        db.delete_column(u'finances_incometemplate', 'account_number_str')

        # Deleting field 'Account.account_number_str'
        db.delete_column(u'finances_account', 'account_number_str')

        # Deleting field 'Bill.account_number_str'
        db.delete_column(u'finances_bill', 'account_number_str')

        # Deleting field 'AccountTemplate.account_number_str'
        db.delete_column(u'finances_accounttemplate', 'account_number_str')

        # Deleting field 'BillTemplate.account_number_str'
        db.delete_column(u'finances_billtemplate', 'account_number_str')

        # Deleting field 'Income.account_number_str'
        db.delete_column(u'finances_income', 'account_number_str')


    def backwards(self, orm):
        # Adding field 'IncomeTemplate.account_number_str'
        db.add_column(u'finances_incometemplate', 'account_number_str',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=30, db_index=True),
                      keep_default=False)

        # Adding field 'Account.account_number_str'
        db.add_column(u'finances_account', 'account_number_str',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=30, db_index=True),
                      keep_default=False)

        # Adding field 'Bill.account_number_str'
        db.add_column(u'finances_bill', 'account_number_str',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=30, db_index=True),
                      keep_default=False)

        # Adding field 'AccountTemplate.account_number_str'
        db.add_column(u'finances_accounttemplate', 'account_number_str',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=30, db_index=True),
                      keep_default=False)

        # Adding field 'BillTemplate.account_number_str'
        db.add_column(u'finances_billtemplate', 'account_number_str',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=30, db_index=True),
                      keep_default=False)

        # Adding field 'Income.account_number_str'
        db.add_column(u'finances_income', 'account_number_str',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=30, db_index=True),
                      keep_default=False)
