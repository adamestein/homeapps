...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'AccountTemplate'
        db.create_table(u'finances_accounttemplate', (
        ...
        db.send_create_signal(u'finances', ['AccountTemplate'])


    def backwards(self, orm):
        # Deleting model 'AccountTemplate'
        db.delete_table(u'finances_accounttemplate')
    ...
    models = {
        ...
        u'finances.accounttemplate': {
            'Meta': {'ordering': "('name',)", 'object_name': 'AccountTemplate'},
