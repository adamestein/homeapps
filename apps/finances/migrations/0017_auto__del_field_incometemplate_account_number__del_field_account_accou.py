...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'IncomeTemplate.account_number'
        db.delete_column(u'finances_incometemplate', 'account_number')

        # Deleting field 'Account.account_number'
        db.delete_column(u'finances_account', 'account_number')

        # Deleting field 'Bill.account_number'
        db.delete_column(u'finances_bill', 'account_number')

        # Deleting field 'AccountTemplate.account_number'
        db.delete_column(u'finances_accounttemplate', 'account_number')

        # Deleting field 'BillTemplate.account_number'
        db.delete_column(u'finances_billtemplate', 'account_number')

        # Deleting field 'Income.account_number'
        db.delete_column(u'finances_income', 'account_number')


    def backwards(self, orm):
        # Adding field 'IncomeTemplate.account_number'
        db.add_column(u'finances_incometemplate', 'account_number',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default='', null=True, blank=True, db_index=True),
                      keep_default=False)

        # Adding field 'Account.account_number'
        db.add_column(u'finances_account', 'account_number',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default='', null=True, blank=True, db_index=True),
                      keep_default=False)

        # Adding field 'Bill.account_number'
        db.add_column(u'finances_bill', 'account_number',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default='', null=True, blank=True, db_index=True),
                      keep_default=False)

        # Adding field 'AccountTemplate.account_number'
        db.add_column(u'finances_accounttemplate', 'account_number',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default='', null=True, blank=True, db_index=True),
                      keep_default=False)

        # Adding field 'BillTemplate.account_number'
        db.add_column(u'finances_billtemplate', 'account_number',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default='', null=True, blank=True, db_index=True),
                      keep_default=False)

        # Adding field 'Income.account_number'
        db.add_column(u'finances_income', 'account_number',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default='', null=True, blank=True, db_index=True),
                      keep_default=False)
