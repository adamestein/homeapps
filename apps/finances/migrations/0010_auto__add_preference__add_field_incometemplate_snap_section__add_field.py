...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'finances_preference', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True)),
            ('snap_days', self.gf('django.db.models.fields.CommaSeparatedIntegerField')(max_length=5)),
        ))
        db.send_create_signal(u'finances', ['Preference'])

        # Adding field 'IncomeTemplate.snap_section'
        db.add_column(u'finances_incometemplate', 'snap_section',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'BillTemplate.snap_section'
        db.add_column(u'finances_billtemplate', 'snap_section',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'finances_preference')

        # Deleting field 'IncomeTemplate.snap_section'
        db.delete_column(u'finances_incometemplate', 'snap_section')

        # Deleting field 'BillTemplate.snap_section'
        db.delete_column(u'finances_billtemplate', 'snap_section')
